...
<table class="table table-hover">		
	...
	<tr>
		...
		<th class="col-sm-2">Pengetahuan</th>
		<th class="col-sm-2">Nama Perusahaan</th>
		<th class="col-sm-3">Alamat Perusahaan</th>
		<th class="col-sm-2">Jam Buka</th>
		<th class="col-sm-2">Pengalaman</th>
	...
	?>
		<tr>
			...
			<td><?php echo $b->jam_buka ?></td>
			<td><?php echo $b->pengalaman ?></td>
			<td>
				<a href="<?= base_url('admin/pengalaman/edit/') . $b->id_pengalaman ?>" class="btn btn-warning">Edit</a>
				<a onclick="if(confirm('Apakah anda yakin ingin menghapus data ini ??')){ location.href="<?= base_url('admin/pengalaman/delete') . $b->id_pengalaman ?>" }" class="btn btn-danger">Hapus</a>
			</td>
		</tr>		
		<?php 
	endforeach;
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form role="form" action="<?php base_url('admin/pengalaman/add') ?>" method="post" enctype="multipart/form-data" >
                <div class="card-body">
				...
				<div class="form-group">
                    ...
                    <textarea class="form-control <?php echo form_error('Pengetahuan') ? 'is-invalid':'' ?>" id="Pengetahuan" style="width: 100%" name="Pengetahuan"></textarea>
                    <div class="invalid-feedback">
				  ...
				  <div class="form-group">
                    ...
                    <input type="text" class="form-control <?php echo form_error('nama_perusahaan') ? 'is-invalid':'' ?>" id="nama_perusahaan" placeholder="Perusahaan" name="nama_perusahaan">
                    <div class="invalid-feedback">
				  ...
				  <div class="form-group">
                    ...
                    <input type="text" class="form-control <?php echo form_error('alamat_perusahaan') ? 'is-invalid':'' ?>" id="alamat_perusahaan" placeholder="Perusahaan" name="alamat_perusahaan">
                    <div class="invalid-feedback">
				  ...
				  <div class="form-group">
                    ...
                    <input type="text" class="form-control <?php echo form_error('jam_buka') ? 'is-invalid':'' ?>" id="jam_buka" placeholder="Perusahaan" name="jam_buka">
                    <div class="invalid-feedback">
				  ...
				  <div class="form-group">
                    ...
                    <input type="text" class="form-control <?php echo form_error('pengalaman') ? 'is-invalid':'' ?>" id="pengalaman" placeholder="Perusahaan" name="pengalaman">
                    <div class="invalid-feedback">
