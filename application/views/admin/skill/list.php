...
<table class="table table-hover">		
	...
	?>
		...
		<tr>
			<td><?php echo $no++ ?></td>
			<td><?php echo $b->keahlian ?></td>
			<td><?php echo $b->persentase ?></td>
			<td>
				<a href="<?= base_url('admin/skill/edit/') . $b->id_skill ?>" class="btn btn-warning">Edit</a>
			...
			<div class="modal-body">
				<form action="<?= base_url('master/skill/add')?>" method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<input name="keahlian" type="text" class="form-control" placeholder="Keahlian Anda">
					</div>
					<div class="form-group">
