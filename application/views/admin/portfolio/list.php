...
<h3><span class="glyphicon glyphicon-book"></span> Portofolio</h3>
...
<?php 
//$per_hal=10;
//$jumlah_record=mysqli_query($koneksi,"SELECT COUNT(*) from portofolio");
...
<table class="table table-hover">		
	...
	?>
		<tr>
			...
			<td>
				<a href="<?= base_url('admin/portfolio/edit/') . $b->id_portofolio ?>" class="btn btn-warning">Edit</a>
				<a onclick="if(confirm('Apakah anda yakin ingin menghapus data ini ??')){ location.href='hapus_portofolio.php?id=<?php echo $b->id_portofolio ?>' }" class="btn btn-danger">Hapus</a>
			</td>
		</tr>		
		<?php 
	endforeach;
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">Tambah Portofolio Baru</h4>
			</div>
			<div class="modal-body">
				<form action="tmb_portofolio.php" method="post" enctype="multipart/form-data">
					<div class="form-group">
						<label>Id Portofolio</label>
						<input name="id_portofolio" readonly="" value="<?php echo $idportofolio; ?>" type="text" class="form-control">
					</div>
					<div class="form-group">
						<label>Judul</label>
