        ...
        <section class="content">
            ...
            <div class="card card-primary">
              ...
              <form role="form" action="<?php base_url('admin/portfolio/edit') ?>" method="post" enctype="multipart/form-data" >
                <div class="card-body">
                <input type="hidden" name="id" value="<?php echo $portfolio->id_portofolio ?>" />
				
				
				<div class="form-group">
                    <label for="keterangan">Judul</label>
                    <textarea class="form-control <?php echo form_error('judul') ? 'is-invalid':'' ?>" id="judul" style="width: 100%" name="judul"><?php echo $portfolio->judul ?></textarea>
