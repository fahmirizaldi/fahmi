...
<table class="table table-hover">		
	...
	<tr>
		...
		<th class="col-sm-2">Nama Sekolah</th>
		<th class="col-sm-2">Tahun Ajar</th>
			...
			<div class="modal-body">
				<form action="tmb_pendidikan.php" method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<input name="Nama_Sekolah" type="text" class="form-control" placeholder="Asal Sekolah Anda">
					</div>	
					<div class="form-group">
						<label>Tahun Ajar</label>
						<input name="Tahun_Ajar" type="text" class="form-control" placeholder="Tahun Ajaran..">
					</div>	
					<div class="form-group">
						<label>Keterangan</label>
						<input name="Keterangan" type="file" class="form-control" placeholder="Keterangan">
					</div>
